...
<body class="dark-mode"> 
    ...
    <div class="container">
        ...
        <div class="layout-grid">
            <div class="card">
                ...
                <div class="settings-grid">
                    <div class="form-group">
                        <label for="multiplier"><i class="fas fa-arrows-alt-v"></i> مضاعف مارتينجال</label>
        ...
        <div class="card">
            ...
            <div class="settings-grid">
                ...
                <div class="form-group">
                    <div class="required-token">
                        <label for="primary-initial-stake"><i class="fas fa-dollar-sign"></i> حجم صفقة المارتينجال الابتدائي (USD) <span style="color: var(--warning);">* قابل للتعديل</span></label>
                        <input type="number" id="primary-initial-stake" value="0.77" step="0.01" min="0.01" max="1000">
                        <small>يتم ضربه بالمضاعف في كل مرحلة خسارة</small>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        // **********************************************
        const MARKETS = [
            { id: 1, name: 'EUR/USD', symbol: 'R_100', token: '', maxConsecutiveLosses: 3, consecutiveLosses: 0, fixedStake: 0.35, usingMartingale: false, enabled: false, isTrading: false, totalPnl: 0, balance: 0, capital: 0, lastSignal: 'WAIT', tickData: [], activeTrades: [], wsConnection: null, connected: false, lastPingTime: 0, lastTradeTime: 0, tradeCooldown: 3000, maxMartingaleStageReached: 0 },
            { id: 2, name: 'GBP/USD', symbol: 'R_50', token: '', maxConsecutiveLosses: 3, consecutiveLosses: 0, fixedStake: 0.35, usingMartingale: false, enabled: false, isTrading: false, totalPnl: 0, balance: 0, capital: 0, lastSignal: 'WAIT', tickData: [], activeTrades: [], wsConnection: null, connected: false, lastPingTime: 0, lastTradeTime: 0, tradeCooldown: 3000, maxMartingaleStageReached: 0 },
            { id: 3, name: 'EUR/USD Forex', symbol: 'frxEURUSD', token: '', maxConsecutiveLosses: 3, consecutiveLosses: 0, fixedStake: 0.35, usingMartingale: false, enabled: false, isTrading: false, totalPnl: 0, balance: 0, capital: 0, lastSignal: 'WAIT', tickData: [], activeTrades: [], wsConnection: null, connected: false, lastPingTime: 0, lastTradeTime: 0, tradeCooldown: 3000, maxMartingaleStageReached: 0 },
            { id: 4, name: 'GBP/USD Forex', symbol: 'frxGBPUSD', token: '', maxConsecutiveLosses: 3, consecutiveLosses: 0, fixedStake: 0.35, usingMartingale: false, enabled: false, isTrading: false, totalPnl: 0, balance: 0, capital: 0, lastSignal: 'WAIT', tickData: [], activeTrades: [], wsConnection: null, connected: false, lastPingTime: 0, lastTradeTime: 0, tradeCooldown: 3000, maxMartingaleStageReached: 0 },
            { id: 5, name: 'Volatility 50 (1s) Index', symbol: '1HZ100V', token: '', maxConsecutiveLosses: 3, consecutiveLosses: 0, fixedStake: 0.35, usingMartingale: false, enabled: false, isTrading: false, totalPnl: 0, balance: 0, capital: 0, lastSignal: 'WAIT', tickData: [], activeTrades: [], wsConnection: null, connected: false, lastPingTime: 0, lastTradeTime: 0, tradeCooldown: 3000, maxMartingaleStageReached: 0 },
            { id: 6, name: 'Volatility 10 Index', symbol: 'R_10', token: '', maxConsecutiveLosses: 3, consecutiveLosses: 0, fixedStake: 0.35, usingMartingale: false, enabled: false, isTrading: false, totalPnl: 0, balance: 0, capital: 0, lastSignal: 'WAIT', tickData: [], activeTrades: [], wsConnection: null, connected: false, lastPingTime: 0, lastTradeTime: 0, tradeCooldown: 3000, maxMartingaleStageReached: 0 },
            { id: 7, name: 'Volatility 25 Index', symbol: 'R_25', token: '', maxConsecutiveLosses: 3, consecutiveLosses: 0, fixedStake: 0.35, usingMartingale: false, enabled: false, isTrading: false, totalPnl: 0, balance: 0, capital: 0, lastSignal: 'WAIT', tickData: [], activeTrades: [], wsConnection: null, connected: false, lastPingTime: 0, lastTradeTime: 0, tradeCooldown: 3000, maxMartingaleStageReached: 0 }
        ];
        ...
        const PRIMARY_TOKEN = {
            ...
            highestStageReached: 0  // أعلى مرحلة مارتينجال وصل لها التوكن الرئيسي
        };
        ...
        function initializeSystem() {
            ...
            uiElements.primaryInitialStake.addEventListener('change', function() {
                ...
                updateUI();
                Logger.add(`تم تحديث حجم صفقة المارتينجال الابتدائي إلى ${PRIMARY_TOKEN.initialStake.toFixed(2)} USD`, 'info');
            });
        }
            ...
            MARKETS.forEach(market => {
                html += `<div class="market-card" id="market-card-${market.id}">
                    ...
                    <div class="market-info">
                        ...
                        <div class="info-item"><div class="info-label">حجم الصفقة</div><div class="info-value" id="market-stake-${market.id}">${market.fixedStake.toFixed(2)} USD</div></div>
        ...
        function updateUI() {
            ...
            MARKETS.forEach(market => {
                ...
                if (card) {
                    ...
                    // إضافة تنبيه إذا وصل السوق للحد الأقصى للمارتينجال
        ...
        class TradingSystem {
            ...
            static openMartingaleTrade(market) {
                ...
                const stake = PRIMARY_TOKEN.martingaleStake;
            ...
            static updateMartingaleSystem(market, isWin) {
                if (isWin) {
                    // فوز في المارتينجال - إعادة تعيين وتحديث أعلى مرحلة
                    ...
                    if (PRIMARY_TOKEN.martingaleStage > PRIMARY_TOKEN.maxMartingale) {
                        ...
                        PRIMARY_TOKEN.martingaleStake = PRIMARY_TOKEN.initialStake * Math.pow(PRIMARY_TOKEN.martingaleMultiplier, PRIMARY_TOKEN.martingaleStage - 1);
            ...
            static activateMartingaleForMarket(market) {
                ...
                Logger.add(`${market.name}: وصل للحد الأقصى للخسائر - تفعيل المارتينجال`, 'warning', market.id);
                showAlert(`${market.name}: تم تفعيل المارتينجال بعد ${market.maxConsecutiveLosses} خسارات متتالية`, 'warning');
                updateUI();
            }
        }
        ...
        function startTestMode() {
            ...
            MARKETS.forEach(market => {
                ...
                market.enabled = hasToken; market.connected = hasToken; market.balance = hasToken ? (capitalInput ? parseFloat(capitalInput.value) || 1000 : 1000) : 0;
